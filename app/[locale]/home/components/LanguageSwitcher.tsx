...
const LanguageSwitcher = ({ isMobile = false, className = '' }: LanguageSwitcherProps) => {
  ...
  return (
    <button
      className={`${baseClasses} ${className} ${isLoading ? 'opacity-75 cursor-wait' : 'hover:bg-gradient-to-r hover:from-[#FBBF24] hover:to-[#FED7AA]'}`}
